    ...
    <section className={ADMIN_LIST_PANEL_CLASS}>
      <div className={ADMIN_LIST_PANEL_HEADER_CLASS}>
        ...
        <button
          ...
          className="inline-flex h-10 cursor-pointer items-center gap-1.5 rounded-full bg-cyan px-4 text-sm font-semibold text-ink shadow-md transition hover:opacity-90"
          aria-label="Add name"
          title="Add name"
        >
